...
# Geração de ata com modelos

> Convenções compartilhadas: `docs/context/CONVENTIONS.md`.

## Objetivo

Permitir gerar a ata formal de uma reunião a partir de um modelo inicial, dados da reunião, registros e relatos selecionados, sem alterar os registros originais. Depois de aplicado, o conteúdo da ata pertence à reunião e pode ser editado localmente.
